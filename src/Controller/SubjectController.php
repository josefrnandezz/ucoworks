...
class SubjectController extends Controller
{
    ...
    {
        return $this->render('_subject/index.html.twig', ['subjects' => $subjectRepository->findAll()]);
    }
    ...
    public function enroll(Request $request, Subject $subject)
    {
        ...
        $this->addFlash('positive', 'El alumno se ha inscrito correctamente');
    ...
    public function unenroll(Request $request, Subject $subject)
    {
        ...
        $this->addFlash('positive', 'El alumno ha sido desmatriculado correctamente');
